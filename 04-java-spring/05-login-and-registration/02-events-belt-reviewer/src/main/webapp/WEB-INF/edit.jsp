...
<%-- 			</form> --%>
			<form id="inputForm" action="/${event.id}/edit" method="post">
		      <input type="hidden" value="${currentUser}" name="host"/>
			<div class="formGroup">
		    ...
		    <div class="formGroup">
 		        ...
 		        <input type="date" class="formInput" name="eventDate" value="${event.eventDate}"/>
		    </div>
			<div class="formGroup">
				<label class="formLabel">State:</label>
				<select class="formInput" name="eventState" value="${event.eventState}">
